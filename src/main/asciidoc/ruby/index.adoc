...
A fairly simple API to retrieve metrics via the `link:../../vertx-core/ruby/yardoc/Vertx/Measured.html[Measured]`
interface which is implemented by various Vert.x components like `link:../../vertx-core/ruby/yardoc/Vertx/HttpServer.html[HttpServer]`,
`link:../../vertx-core/ruby/yardoc/Vertx/NetServer.html[NetServer]`, and even `link:../../vertx-core/ruby/yardoc/Vertx/Vertx.html[Vertx]` itself.
...
The `link:../cheatsheet/DropwizardMetricsOptions.html#registryName[vertx.metrics.options.registryName]`
configures the <<dropwizard-registry,Dropwizard Registry>> to use.

The `link:../cheatsheet/DropwizardMetricsOptions.html#jmxEnabled[vertx.metrics.options.jmxEnabled]` and
`link:../cheatsheet/DropwizardMetricsOptions.html#jmxDomain[vertx.metrics.options.jmxDomain]`
configures the <<jmx,JMX>> registration.

The `link:../cheatsheet/DropwizardMetricsOptions.html#configPath[vertx.metrics.options.configPath]`
...
`link:../../vertx-core/ruby/yardoc/Vertx/Measured.html[Measured]` object which provides a map of the metric name to the data,
...
Since `link:../../vertx-core/ruby/yardoc/Vertx/HttpServer.html[HttpServer]` implements `link:../../vertx-core/ruby/yardoc/Vertx/Measured.html[Measured]`, you can easily grab all metrics
