...
fun DropwizardMetricsOptions(
  ...
  monitoredEventBusHandlers: List<io.vertx.ext.dropwizard.Match>? = null,
  monitoredHttpClientEndpoints: List<io.vertx.ext.dropwizard.Match>? = null,
  monitoredHttpClientUris: List<io.vertx.ext.dropwizard.Match>? = null,
  monitoredHttpServerUris: List<io.vertx.ext.dropwizard.Match>? = null,
