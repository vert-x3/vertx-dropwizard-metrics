...
public class JmxReporter implements Closeable {
  ...
  public static class Builder {
    ...
    /**
     * Register MBeans with the given {@link javax.management.MBeanServer}.
     *
     * @param mBeanServer     an {@link javax.management.MBeanServer}
     * @return {@code this}
     */
    ...
    /**
     * Use specific {@link java.util.concurrent.TimeUnit}s for the duration of the metrics with these names.
     *
     * @param specificDurationUnits a map of metric names and specific {@link java.util.concurrent.TimeUnit}s
     * @return {@code this}
     */
    ...
    /**
     * Use specific {@link java.util.concurrent.TimeUnit}s for the rate of the metrics with these names.
     *
     * @param specificRateUnits a map of metric names and specific {@link java.util.concurrent.TimeUnit}s
     * @return {@code this}
     */
