 ...
 * = Metrics
 *
 * Vert.x metrics provides a fairly simple API to retrieve metrics via the {@link io.vertx.core.metrics.Measured Measured}
 ...
 * a map of the metric name to the data, represented by a {@link io.vertx.core.json.JsonObject}. So for example if we
